defmodule Neo4j.Sips.Model do @doc false
  ...
  - https://github.com/raw1z/ex_neo4j/tree/master/lib/ex_neo4j/model
  ...
  defmacro __before_compile__(env) do
    metadata = Neo4j.Sips.Model.Metadata.new(env.module)

    quote do
      unquote Neo4j.Sips.Model.Struct.generate(metadata)
      unquote Neo4j.Sips.Model.ParseNodeMethod.generate(metadata)
      unquote Neo4j.Sips.Model.BuildMethod.generate(metadata)
      unquote Neo4j.Sips.Model.SaveMethod.generate(metadata)
      unquote Neo4j.Sips.Model.CreateMethod.generate(metadata)
      unquote Neo4j.Sips.Model.UpdateMethod.generate(metadata)
      unquote Neo4j.Sips.Model.FindMethod.generate(metadata)
      unquote Neo4j.Sips.Model.DeleteMethod.generate(metadata)
      unquote Neo4j.Sips.Model.Serialization.generate(metadata)
      unquote Neo4j.Sips.Model.Validations.generate(metadata)
