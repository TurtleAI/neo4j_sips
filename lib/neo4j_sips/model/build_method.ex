defmodule Neo4j.Sips.Model.BuildMethod do

  def generate(metadata) do
    quote do
      require Neo4j.Sips.Model.ModelBuilder

      def build, do: Neo4j.Sips.Model.ModelBuilder.build(__MODULE__)
      def build(params) when is_list(params) or is_map(params) do
        Neo4j.Sips.Model.ModelBuilder.build(__MODULE__, params)
      end
