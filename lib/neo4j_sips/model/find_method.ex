defmodule Neo4j.Sips.Model.FindMethod do
  def generate(metadata) do
    quote do
      ...
      def find(properties) when is_list(properties) do
        query = Neo4j.Sips.Model.FindQueryGenerator.query_with_properties(__MODULE__, properties)
      ...
      def find(id) do
        query = Neo4j.Sips.Model.FindQueryGenerator.query_with_id(__MODULE__, id)
